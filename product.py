...
class productClass:
    def __init__(self,root):
        ...
        #=======================Title=========================
        title=Label(product_Frame,text="Product Detalis",font=("goudy old style",18),bg="#0f4d7d",fg="white").pack(side=TOP,fill=X)
        ...
        #=======================Buttons=================
        btn_add=Button(product_Frame,text="Save",command=self.add,font=("goudy old style",15),bg="blue",fg="white",cursor="hand2").place(x=10,y=400,width=80,height=28)
        btn_update=Button(product_Frame,text="Update",command=self.update,font=("goudy old style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=95,y=400,width=80,height=28)
