...
class IMS:
    def __init__(self,root):
       ...
       btn_supplier=Button(LeftMenu,text="Supplier",image=self.icon_side,compound=LEFT,padx=20,anchor=W,font=("times new roman",20,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
       btn_category=Button(LeftMenu,text="Category",image=self.icon_side,compound=LEFT,padx=20,anchor=W,font=("times new roman",20,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
       btn_products=Button(LeftMenu,text="Products",image=self.icon_side,compound=LEFT,padx=20,anchor=W,font=("times new roman",20,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
       btn_sales=Button(LeftMenu,text="Sales",image=self.icon_side,compound=LEFT,padx=20,anchor=W,font=("times new roman",20,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
