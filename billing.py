...
class BillingClass:
    ...
    def __init__(self,root):
        ...
        lbl_search = Label(ProductFrame2, text="Search Product | By Name", font=("goudy new roman", 15, "bold"),
                           bg="white", fg="green").place(x=2, y=5)
        lbl_search = Label(ProductFrame2, text="Product Name", font=("goudy new roman", 15, "bold"), bg="white").place(
            x=2, y=45)
        ...
        cTitle = Label(CustomerFrame, text="Customer Detalis", font=("goudy old style", 15), bg="lightgrey").pack(
            side=TOP, fill=X)
        ...
        lbl_contact = Label(CustomerFrame, text="Contact No.", font=("goudy new roman", 15), bg="white").place(x=270,
                                                                                                               y=35)
        ...
        self.CartTable = ttk.Treeview(cart_Frame, columns=("pid", "name", "price", "qty"), yscrollcommand=scrolly.set,
        ...
        txt_p_name = Entry(Add_cartWidgetsFrame, textvariable=self.var_pname, font=("times new roman", 15),
                           bg="lightgrey", state='readonly').place(x=5, y=35, width=190, height=22)
        ...
        txt_p_price = Entry(Add_cartWidgetsFrame, textvariable=self.var_price, font=("times new roman", 15),
                            bg="lightgrey", state='readonly').place(x=230, y=35, width=150, height=22)
        ...
        txt_p_qty = Entry(Add_cartWidgetsFrame, textvariable=self.var_qty, font=("times new roman", 15),
                          bg="lightgrey").place(x=390, y=35, width=120, height=22)
        ...
        if self.var_pid.get() == '':
            ...
            if present == 'yes':
                op = messagebox.askyesno('Confirm',
                                         "Product already present\nDo you wat to Update| Remove from the cart list",
                                         parent=self.root)
                if op == True:
