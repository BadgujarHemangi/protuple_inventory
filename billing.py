...
class BillingClass:
    def __init__(self,root):
       ...
       #==================product details frame======================================================
        ...
        btn_print=Button(billMenuFrame,text='Print',cursor="hand2",font=("goudy old style",15,"bold"),bg="pink",fg="white")
        ...
        btn_generate=Button(billMenuFrame,text='Generate/Save',cursor="hand2",font=("goudy old style",15,"bold"),bg="#009688",fg="white")
        ...
        btn_clear_cart=Button(Add_cartWidgetsFrame,text="Clear",font=("times new roman",15,"bold"),bg="grey",cursor="hand2").place(x=180,y=70,width=150,height=30)
