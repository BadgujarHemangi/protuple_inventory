...
class employeeClass:
    ...
    def __init__(self,root):
        ...
        btn_exit=Button(self.root,text="Exit",command=self.exit,font=("goudy old style",15),bg="darkkhaki",fg="black",cursor="hand2").place(x=930,y=9,width=130,height=30)
        ...
        txt_contact=Entry(self.root,textvariable=self.var_contact,font=("goudy old style",15),bg="lightyellow",cursor="hand2").place(x=850,y=150,width=180)

        #===row2===============
        lbl_name=Label(self.root,text="Name",font=("goudy old style",15),bg="white",cursor="hand2").place(x=50,y=190)
        ...
        #=====button====
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="blue",fg="white",cursor="hand2").place(x=500,y=305,width=110,height=28)
